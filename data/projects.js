const featuredProjects = [
  {
    ...
    architecture: ["User Query", "Router Agent", "Nutrition/Workout Agent", "Safety Validator", "State Store"],
  ...
  },
  {
    ...
    architecture: ["User Prompt", "FAISS Retriever", "Draft Generator", "Critic Agent", "Final Output"],
    metrics: [{label: "Placeholder Metric", value: "XX%"}, {label: "Another Metric", value: "XXms"}],
    demoLink: "https://argus-ai-rag-kz2s78uomwwpcwbinjjwsp.streamlit.app/",
    demoText: "Live Demo ↗",
    codeLink: "https://github.com/TinkerTechie/argus-ai-rag.git",
    codeText: "Code ↗"
  },
  {
    ...
    architecture: ["Student Input", "Belief-State Tracker", "Misconception Taxonomy", "Question Generator", "Response"],
    metrics: [{label: "Placeholder Metric", value: "XX%"}, {label: "Another Metric", value: "XXms"}],
  ...
  },
  {
    ...
    architecture: ["News Article", "Scikit-learn Classifier", "RAG Evidence Retrieval", "LLM Synthesizer", "Verdict & Explanation"],
    metrics: [{label: "Placeholder Metric", value: "XX%"}, {label: "Another Metric", value: "XXms"}],
